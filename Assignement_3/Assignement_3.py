...
def get_user_input():
    ...
    try:
        ...
        if "Top-p must be" in str(e):
            print(f"Invalid top-p: {e}")
        else:
    ...
    try:
        ...
        if "Presence penalty must be" in str(e):
            print(f"Invalid presence penalty: {e}")
        else:
    ...
    try:
        ...
        if "Frequency penalty must be" in str(e):
            print(f"Invalid frequency penalty: {e}")
        else:
